    ...
    def handle_message(self, message):
        ...
        try:
            ...
            if text == "/start" or text.startswith("/start "):
                ...
                logger.info(f"Отправлено приветственное сообщение пользователю {name} (ID: {chat_id})")
                return
            ...
            try:
                ...
                self.send_message(chat_id, "Произошла ошибка при обработке сообщения. Попробуйте ещё раз.")
            except:
